...
public class SqlHBaseSink extends AbstractSink implements Configurable {
    ...
    private static final Logger logger =
            LoggerFactory.getLogger(SqlHBaseSink.class);
    ...
    public SqlHBaseSink(Configuration conf) {
     ...
     */
        ...
        Callback<Object, Object> delSuccessCallback =
                new SuccessCallback<Object, Object>(
                        lock, callbacksReceived, condition);
        Callback<Object, Object> delFailureCallback =
                new FailureCallback<Object, Object>(
                        lock, callbacksReceived, txnFail, condition);
        ...
        try {
            ...
            for (; i < batchSize; i++) {
                ...
                if (event == null) {
                    ...
                    List<DeleteRequest> delActions = serializer.getActionsDelete();
                    for (DeleteRequest deleteRequest : delActions) {
                        deleteRequest.setDurable(enableWal);
                        client.delete(deleteRequest).addCallbacks(delSuccessCallback, delFailureCallback);
                    }
